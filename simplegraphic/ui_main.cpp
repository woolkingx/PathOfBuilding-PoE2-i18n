...
static std::string EncodeCodepointUTF8(int codepoint)
{
...
void ui_main_c::CallCharHandler(const char* hname, int codepoint)
{
	if ( !L ) return;
	...
	std::string text = EncodeCodepointUTF8(codepoint);
